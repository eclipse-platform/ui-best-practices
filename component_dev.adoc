...
- menu:Project[] menu: menu:Open Project[], menu:Close Project[], menu:Build Project[], menu:Rebuild 
  Project[]
...
deploying. Each perspective will fall into one of these steps. The menu:Open
...
With regard to command contributions applied to the menu:New[], menu:Open
Perspective[], and menu:Show View[] menus, the list of wizards, perspectives, and
...
The menu:Navigate[] menu contains navigational actions such as menu:Go to[], menu:Open
Type[], menu:Show In[], to enable users to browse laterally or drill down in
their code.
