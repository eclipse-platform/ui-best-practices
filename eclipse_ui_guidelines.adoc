...
== UI Checklist
The link:top_ten_lists.adoc[Top Ten Lists] is a shortlist of the most relevant
and easy to apply Eclipse **User Interface Guidelines**. 
Start by using link:top_ten_lists.adoc[this list], referring to the linked guideline items for details, 
then use the link:eclipse_ui_full_checklist.adoc[Full Checklist] for additional guidance. 
...
- link:standard_components.adoc[*Standard Components*] +
  Guidelines for the standard components which ship with Eclipse.   

- link:flat_look_design.adoc[*Flat Look Design*] +
  Design alternative for implementing content editors.   

- link:flat_look_design.adoc[*The Tao of Resource*] +
